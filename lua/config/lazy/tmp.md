...
Extmark will be used to annotate text with metadata a highlighting group name.
Based on this Neovim will change the style of your piece of text.
...
The fact that by executing several commands you can highlight anything you want is very useful but, for sure, doing it that way is tedious (unless you believe you are a cool hacker, who loves typing Neovim commands)
The most common way to overcome this is to wrap you code into plugin, make it load automatically on vim startup and bind this highlighting magic to the single command or keystroke
So, let’s bring our small plugin to life!
...
-- basically nvim auto cmd 
`~/.config/plugin/highline.vim`:
